    ...
    <>
      <div className="p-6">
        ...
        <div class="flex flex-row mb-3">
          <div class="basis-1/4">Created Name</div>
          <div class="basis-3/4">{item?.byCreated?.name ?? ""}</div>
        </div>
        ...
        <div class="flex flex-row mb-3">
          <div class="basis-1/4">Need Approval Total</div>
          <div class="basis-3/4">{item?.needApprovals?.length}</div>
        </div>
